public class Elby {
    ...
    public String getResponse(String statement) {
        ...
        || findKeyword(statement,"brother",statement.indexOf("bother")) >= 0) {
            response = "Tell me more about your family.";
        }else if (statement.indexOf("no") >= 0) {
            response = "Why so negative?";
        }
        else if (findKeyword(statement,"cat",statement.indexOf("cat")) >= 0
        || findKeyword(statement,"dog",statement.indexOf("dog"))>= 0
        || findKeyword(statement,"bird",statement.indexOf("bird"))>= 0
        ||findKeyword(statement,"pet",statement.indexOf("pet"))>= 0) {
            response = "Tell me more about your pets.";
        }else if (statement.indexOf("Estella") >= 0
        || statement.indexOf("estella") >= 0)
        {
            response = "She sounds like a good student.";
        ...
        || statement.indexOf("instrument") >= 0
        || statement.indexOf("classical") >= 0
